...
OPENCLAW_CONFIG_DIR="${OPENCLAW_CONFIG_DIR:-/volume1/docker/openclaw}"
OPENCLAW_WORKSPACE_DIR="${OPENCLAW_WORKSPACE_DIR:-/volume1/docker/openclaw/workspace}"
...
export OPENCLAW_MACVLAN_NETWORK="${OPENCLAW_MACVLAN_NETWORK:-macvlan}"
export OPENCLAW_MACVLAN_IP="${OPENCLAW_MACVLAN_IP:-192.168.11.218}"
